...
def seed_categories():
    ...
    income_categories = [
        ...
        ('Личное или подарки', ['Денежный подарок', 'Перевод', 'Возврат долга', 'Продажа личных вещей',
...
def seed_transaction():
    ...
    incomes = [
        ...
        },
        {
            ...
            'amount': 6,
            'comment': 'Ежемесячный кэш-бек за обычные покупки',
            'transacted_at': '2025-06-22 12:00:00.053179',
            'source': 'Tinkoff Black',
        },
        {
            'user_cashbox_id': 1,
            ...
            'subcategory_id': 134,
            'amount': 821,
            'comment': 'Перевод за пиццу',
            'transacted_at': '2025-06-27 12:00:00.053179',
            'source': 'Сергей Л.',
        },
        {
            'user_cashbox_id': 1,
        ...
        },
        {
            ...
            'subcategory_id': 134,
            'amount': 400,
            'comment': 'Перевод за оплату анти-кафе',
            'transacted_at': '2025-06-27 12:00:00.053179',
            'source': 'Лев Ч.',
        },
        {
            ...
            'amount': 822,
            'comment': 'Перевод за пиццу',
            'transacted_at': '2025-06-28 12:00:00.053179',
            'source': 'Карим М.',
        },
        {
            'user_cashbox_id': 1,
            ...
            'subcategory_id': 134,
            'amount': 6000,
            'comment': 'Перевод за покупку в ECRU',
            'transacted_at': '2025-07-15 12:00:00.053179',
            'source': 'Анна М.',
        },
        {
            'user_cashbox_id': 1,
            ...
            'amount': 138,
            'comment': 'Ежемесячный кэш-бек за обычные покупки',
            'transacted_at': '2025-07-22 12:00:00.053179',
            'source': 'Tinkoff Black',
        },
        {
            'user_cashbox_id': 1,
            ...
            'subcategory_id': 134,
            'amount': 5000,
            'comment': 'Обналичивание средств',
            'transacted_at': '2025-07-23 12:00:00.053179',
            'source': 'Петр М.',
        },
        {
            'user_cashbox_id': 3,
            ...
            'subcategory_id': 134,
            'amount': 5000,
            'comment': 'Перевод от тёти Любы',
            'transacted_at': '2025-06-29 12:00:00.053179',
            'source': 'Любовь Николаевна Р.',
        },
        {
            'user_cashbox_id': 3,
            'category_id': 20,
            'subcategory_id': 134,
            'amount': 240,
            'comment': 'Перевод за ЛавашОк',
            'transacted_at': '2025-06-30 12:00:00.053179',
            'source': 'Давыт Мехманович Г.',
        },
        {
            'user_cashbox_id': 7,
            'category_id': 16,
            'subcategory_id': 112,
            'amount': 5000,
            'comment': 'Стипендиальная выплата от КФУ',
            'transacted_at': '2025-06-25 12:00:00.053179',
            'source': 'К(П)ФУ',
        },
        {
            'user_cashbox_id': 7,
            ...
            'amount': 5000,
            'comment': 'Стипендиальная выплата от КФУ',
            'transacted_at': '2025-07-25 12:00:00.053179',
            'source': 'К(П)ФУ',
        },
        {
            'user_cashbox_id': 5,
        ...
        },
        {
            ...
            'subcategory_id': 133,
            'amount': 2000,
            'comment': 'Подарок от бабули Вали',
            'transacted_at': '2025-07-09 12:00:00.053179',
            'source': 'Мирнова В.',
        },
        {
            'user_cashbox_id': 5,
            ...
            'amount': 15000,
            'comment': 'Обналичивание средств',
            'transacted_at': '2025-07-03 12:00:00.053179',
            'source': 'Мирнов П.',
        },
    ]
    expense = [
        ...
        },
        {
            ...
            'amount': 3942.16,
            'comment': 'Оплата услуг общежития',
            'transacted_at': '2025-06-23 13:57:54.053179',
            'vendor': 'КФУ Приволжский',
            'location': 'Деревня Универсиады, д.3',
        },
        {
        ...
        },
        {
            ...
            'subcategory_id': 7,
            'amount': 575.52,
            'comment': 'Поход в магазин',
            'transacted_at': '2025-06-24 13:57:54.053179',
            'vendor': 'Пятёрочка',
            'location': 'Набережные Челны, ул. Ильдара Маннанова 5',
        },
        {
            'user_cashbox_id': 1,
            'category_id': 10,
            'subcategory_id': 68,
            'amount': 66,
            'comment': 'Ёмкости для анализов',
            'transacted_at': '2025-06-24 13:57:54.053179',
            'vendor': 'Аптека',
            'location': 'Набережные Челны, ул. Раскольникова 27/17',
        },
        {
            'user_cashbox_id': 1,
            'category_id': 3,
            ...
            'amount': 223,
            'comment': 'Такси до парикмахерской',
            'transacted_at': '2025-06-25 13:57:54.053179',
            'vendor': 'Яндекс Такси',
            'location': 'Набережные Челны',
        },
        {
            ...
            'subcategory_id': 20,
            'amount': 465,
            'comment': 'Такси с парикмахерской',
            'transacted_at': '2025-06-25 13:57:54.053179',
            'vendor': 'Яндекс Такси',
            'location': 'Набережные Челны',
        },
        ...
        },
        {
            ...
            'amount': 700,
            'comment': 'Перевод за поездку на BlaBlaCar',
            'transacted_at': '2025-06-26 13:57:54.053179',
            'vendor': 'Ольга П.',
            'location': 'Набережные Челны',
        },
        {
        ...
        },
        {
            ...
            'subcategory_id': 14,
            'amount': 4931,
            'comment': 'Общак Додо-Пицца',
            'transacted_at': '2025-06-27 13:57:54.053179',
            'vendor': 'Додо Пицца',
            'location': 'Казань',
        },
        {
            ...
            'subcategory_id': 101,
            'amount': 6.90,
            'comment': 'Списание за Yandex облако',
            'transacted_at': '2025-06-27 13:57:54.053179',
            'vendor': 'Yandex Cloud',
            'location': 'Москва',
        },
        ...
        },
        {
            ...
            'amount': 190,
            'comment': 'Сервисный сбор BlaBlaCar',
            'transacted_at': '2025-06-28 13:57:54.053179',
            'vendor': 'BlaBlaCar',
            'location': 'Казань',
        },
        {
        ...
        },
        {
            ...
            'amount': 140,
            'comment': 'Сервисный сбор BlaBlaCar',
            'transacted_at': '2025-06-29 13:57:54.053179',
            'vendor': 'BlaBlaCar',
            'location': 'Набережные Челны',
        },
        {
            ...
            'amount': 700,
            'comment': 'Перевод за поездку на BlaBlaCar',
            'transacted_at': '2025-06-30 13:57:54.053179',
            'vendor': 'Ринат З.',
            'location': 'Набережные Челны',
        },
        {
        ...
        },
        {
            ...
            'subcategory_id': 101,
            'amount': 250,
            'comment': 'Плата за годовое обслуживание карты',
            'transacted_at': '2025-06-30 13:57:54.053179',
            'vendor': 'Сбербанк',
            'location': 'Казань',
        },
        {
            ...
            'subcategory_id': 2,
            'amount': 119.95,
            'comment': 'Покупка фруктов',
            'transacted_at': '2025-07-02 13:57:54.053179',
            'vendor': 'Челны Хлеб',
            'location': 'Набережные Челны',
        },
        {
            ...
            'amount': 15000,
            'comment': 'Обналичивание средств',
            'transacted_at': '2025-07-03 13:57:54.053179',
            'vendor': 'Миронов Петр',
            'location': 'Набережные Челны',
        },
        {
            ...
            'amount': 649.72,
            'comment': 'Покупка фруктов',
            'transacted_at': '2025-07-05 13:57:54.053179',
            'vendor': 'Челны Хлеб',
            'location': 'Набережные Челны',
        },
        {
        ...
        },
        {
            ...
            'subcategory_id': 11,
            'amount': 112.9,
            'comment': 'Детское питание Gerber',
            'transacted_at': '2025-07-09 13:57:54.053179',
            'vendor': 'Челны Хлеб',
            'location': 'Набережные Челны',
        },
        {
            ...
            'subcategory_id': 7,
            'amount': 383.8,
            'comment': 'Покупка сахара для варенья',
            'transacted_at': '2025-07-09 13:57:54.053179',
            'vendor': 'Пятёрочка',
            'location': 'Набережные Челны',
        },
        ...
        },
        {
            ...
            'amount': 650,
            'comment': 'Перевод за поездку на BlaBlaCar',
            'transacted_at': '2025-07-10 13:57:54.053179',
            'vendor': 'Марат С.',
            'location': 'Набережные Челны',
        },
        {
        ...
        },
        {
            ...
            'amount': 387.13,
            'comment': 'Покупка овощей',
            'transacted_at': '2025-07-11 13:57:54.053179',
            'vendor': 'Пятёрочка',
            'location': 'Набережные Челны',
        },
        {
            ...
            'subcategory_id': 57,
            'amount': 6097,
            'comment': 'Образ на выпуск',
            'transacted_at': '2025-07-14 13:57:54.053179',
            'vendor': 'ECRU',
            'location': 'Набережные Челны',
        },
        {
            ...
            'amount': 81.84,
            'comment': 'Покупка овощей',
            'transacted_at': '2025-07-18 13:57:54.053179',
            'vendor': 'Пятёрочка',
            'location': 'Набережные Челны',
        },
        {
            ...
            'amount': 389.06,
            'comment': 'Покупка еды',
            'transacted_at': '2025-07-20 13:57:54.053179',
            'vendor': 'Челны Хлеб',
            'location': 'Набережные Челны',
        },
        {
        ...
        },
        {
            ...
            'amount': 307,
            'comment': 'Такси до дома',
            'transacted_at': '2025-07-21 13:57:54.053179',
            'vendor': 'Яндекс Такси',
            'location': 'Набережные Челны',
        },
        {
            ...
            'amount': 180,
            'comment': 'Сервисный сбор BlaBlaCar',
            'transacted_at': '2025-07-22 13:57:54.053179',
            'vendor': 'BlaBlaCar',
            'location': 'Набережные Челны',
        },
        {
        ...
        },
        {
            ...
            'amount': 600,
            'comment': 'Перевод за поездку на BlaBlaCar',
            'transacted_at': '2025-07-23 13:57:54.053179',
            'vendor': 'Фарит С.',
            'location': 'Набережные Челны',
        },
        {
        ...
        },
        {
            ...
            'subcategory_id': 14,
            'amount': 569,
            'comment': 'Трапеза в Маке',
            'transacted_at': '2025-07-23 13:57:54.053179',
            'vendor': 'Вкусно - и точка',
            'location': 'Казань',
        },
        {
            'user_cashbox_id': 1,
        ...
        },
        {
            ...
            'amount': 16,
            'comment': 'Перец чили',
            'transacted_at': '2025-07-25 13:57:54.053179',
            'vendor': 'Овощная лавка',
            'location': 'Набережные Челны',
        },
        {
            'user_cashbox_id': 1,
        ...
        },
        {
            ...
            'subcategory_id': 62,
            'amount': 1000,
            'comment': 'Парикмахерская для Макара',
            'transacted_at': '2025-06-25 13:57:54.053179',
            'vendor': 'Тётя Роза',
            'location': 'Набережные Челны',
        },
        {
            ...
            'subcategory_id': 62,
            'amount': 1000,
            'comment': 'Парикмахерская перед выпуском',
            'transacted_at': '2025-07-20 13:57:54.053179',
            'vendor': 'Тётя Роза',
            'location': 'Набережные Челны',
        },
        {
            ...
            'subcategory_id': 101,
            'amount': 2000,
            'comment': 'Обналичивание средств для Макара',
            'transacted_at': '2025-07-17 13:57:54.053179',
            'vendor': 'Миронов Макар',
            'location': 'Набережные Челны',
        },
        {
            'user_cashbox_id': 5,
