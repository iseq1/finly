import { renderExpenseStatisticsTable } from '/static/js/expense/render_transaction_statistic_table.js';
import { handleCategoryPopup } from '/static/js/expense/handle_popup_by_category.js';
import { handleProviderPopup } from '/static/js/expense/handle_popup_by_cashbox.js';
import { handleDetailPopup } from '/static/js/expense/handle_popup_detail.js';
import { getDateRangeFromInputs } from '/static/js/expense/utils.js';
import { hidePopup } from '/static/js/expense/show_provider_popup.js';
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  await renderExpenseStatisticsTable({ start_date, end_date });
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  filterButton.addEventListener('click', async (event) => {
    ...
    await renderExpenseStatisticsTable({
      start_date,
      end_date,
