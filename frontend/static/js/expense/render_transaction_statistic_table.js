import { fetchExpenseStatistic } from '/static/js/expense/fetch_statistic.js';

export async function renderExpenseStatisticsTable({ start_date, end_date, include_empty_categories = 'true' }) {
  ...
  const response = await fetchExpenseStatistic(params);
